...
export default function ProjectDetailSidebar({ project, marketData, ratingsData, coinDetail }: Props) {
  ...
  return (
    <div className="space-y-4 lg:sticky lg:top-20 lg:self-start lg:max-h-[calc(100vh-6rem)] lg:overflow-y-auto scrollbar-none" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
