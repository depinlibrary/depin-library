        ...
        >
          <div className="group relative">
            ...
            <input
              ...
              className="h-13 w-full rounded-xl border border-border bg-card/80 py-3.5 pl-12 pr-4 text-sm text-foreground placeholder:text-muted-foreground backdrop-blur-sm transition-all focus:border-primary/50 focus:outline-none focus:ring-1 focus:ring-primary/30 glow-primary-sm"
            />
          </div>
        </motion.div>
      </div>
