  ...
  return (
    ...
    >
      <Link
        ...
        className="group relative flex h-full flex-col rounded-xl border border-border bg-card p-5 transition-all duration-300 hover:border-primary/50 hover:bg-card/80"
      >
        {/* Bookmark button */}
        {user && (
          <button
